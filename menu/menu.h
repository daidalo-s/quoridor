...
#define SGM_Y_FIRST_SELECTION (SGM_Y_TEXT_AREA_LINE_2 + 20 + 16)
...
#define SSB_Y_FIRST_SELECTION (SSB_Y_TEXT_AREA_LINE_2 + 20 + 16)
...
#define STB_Y_FIRST_SELECTION (STB_Y_TEXT_AREA_LINE_2 + 20 + 16)
